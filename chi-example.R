...
# There is also a built-in Chi-squared goodness of fit test, chisq.test.  It appears that the command requires
# the comparison distribution, which is what is done in the e function.